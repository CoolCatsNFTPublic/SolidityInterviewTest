...
interface ItemFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "_lastClaimed(address)": FunctionFragment;
...
export class ItemFactory extends BaseContract {
  ...
  functions: {
    ...
    _lastClaimed(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
