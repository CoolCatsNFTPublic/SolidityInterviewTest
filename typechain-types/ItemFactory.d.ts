...
interface ItemFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "_allowedClaimInterval()": FunctionFragment;
    "_commonRoll()": FunctionFragment;
    "_epicRoll()": FunctionFragment;
    "_lastClaim(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_allowedClaimInterval",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: "_lastClaim", values: [string]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "_lastClaim", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "_lastUpdate",
    data: BytesLike
  ): Result;
...
export class ItemFactory extends BaseContract {
  ...
  functions: {
    ...
    _allowedClaimInterval(overrides?: CallOverrides): Promise<[BigNumber]>;

    _commonRoll(overrides?: CallOverrides): Promise<[number]>;

    _epicRoll(overrides?: CallOverrides): Promise<[number]>;

    _lastClaim(arg0: string, overrides?: CallOverrides): Promise<[BigNumber]>;
