...
export interface ItemFactoryInterface extends utils.Interface {
  ...
  functions: {
    ...
    "_rewardMapping(uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_rewardMapping",
...
export type LogDailyClaimEvent = TypedEvent<
...
export type LogDailyClaimEventFilter = TypedEventFilter<LogDailyClaimEvent>;
...
export interface ItemFactory extends BaseContract {
  contractName: "ItemFactory";
  ...
  filters: {
    ...
    "LogDailyClaim(address,uint256,uint256,bytes)"(
      claimer?: string | null,
      rewardType?: BigNumberish | null,
      rewardRarity?: BigNumberish | null,
      rewardData?: null
    ): LogDailyClaimEventFilter;
    LogDailyClaim(
      claimer?: string | null,
      rewardType?: BigNumberish | null,
      rewardRarity?: BigNumberish | null,
